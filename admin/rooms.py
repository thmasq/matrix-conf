...
class RoomManager:
        ...
        try:
            ...
            while True:
                ...
                while True:
                    ...
                    FilterSortUI.show_filter_sort_status(current_filter, current_filter_type, current_sort, 
                                                       len(all_rooms), len(filtered_rooms), "rooms")
                    ...
                    if filtered_rooms:
                        ...
                        for i, room in enumerate(current_rooms):
                            print(DataFormatter.format_room_info_enhanced(room, start_index + i))
                    else:
                        print("No rooms match the current filter.")
                    
                    # Show navigation options
                    FilterSortUI.show_navigation_options(paginator.needs_pagination(), bool(filtered_rooms))
                    ...
                    elif choice == '' and not filtered_rooms:
                ...
                while True:
                    ...
                    if filtered_rooms:
                        ...
                        for i, room in enumerate(current_rooms):
                            ...
                            print(DataFormatter.format_room_info_enhanced(room, global_index))
                    else:
                        print("No rooms match the current filter.")
    ...
    def delete_selected_rooms(self, selected_rooms: List[Dict]):
        ...
        for i, room in enumerate(selected_rooms, 1):
            ...
            try:
                ...
                response = self.client.make_request('DELETE', f'/_synapse/admin/v1/rooms/{room_id}', delete_data)
        ...
        # Show summary
        ProgressMonitor.show_operation_summary("DELETION", len(successful_deletions), len(failed_deletions), failed_deletions)
    ...
    def monitor_deletion(self, delete_id: str):
        ...
        for attempt in range(10):  # Check up to 10 times
            try:
                response = self.client.make_request('GET', f'/_synapse/admin/v1/rooms/delete_status/{delete_id}')
    ...
    def fix_single_room_permissions(self, room_input: str):
        ...
        try:
            ...
            power_levels = self.client.make_request('GET', f'/_matrix/client/v3/rooms/{room_id}/state/m.room.power_levels')
            ...
            # Apply changes
            response = self.client.make_request('PUT', f'/_matrix/client/v3/rooms/{room_id}/state/m.room.power_levels', power_levels)
